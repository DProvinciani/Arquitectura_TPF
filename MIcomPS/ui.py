...
class MicompsFrame(wx.Frame):
    ...
    def __make_lists(self):
        self.list_inputs_step1 = dv.DataViewListCtrl(self.panel_left_step1, wx.ID_ANY)
        self.list_inputs_step1.AppendTextColumn("Name")
        self.list_inputs_step1.AppendTextColumn("Value")
        self.list_outputs_step1 = dv.DataViewListCtrl(self.panel_right_step1, wx.ID_ANY)
        self.list_outputs_step1.AppendTextColumn("Name")
        self.list_outputs_step1.AppendTextColumn("Value")
        self.list_inputs_step2 = dv.DataViewListCtrl(self.panel_left_step2, wx.ID_ANY)
        self.list_inputs_step2.AppendTextColumn("Name")
        self.list_inputs_step2.AppendTextColumn("Value")
        self.list_outputs_step2 = dv.DataViewListCtrl(self.panel_right_step2, wx.ID_ANY)
        self.list_outputs_step2.AppendTextColumn("Name")
        self.list_outputs_step2.AppendTextColumn("Value")
        self.list_inputs_step3 = dv.DataViewListCtrl(self.panel_left_step3, wx.ID_ANY)
        self.list_inputs_step3.AppendTextColumn("Name")
        self.list_inputs_step3.AppendTextColumn("Value")
        self.list_outputs_step3 = dv.DataViewListCtrl(self.panel_right_step3, wx.ID_ANY)
        self.list_outputs_step3.AppendTextColumn("Name")
        self.list_outputs_step3.AppendTextColumn("Value")
        self.list_inputs_step4 = dv.DataViewListCtrl(self.panel_left_step4, wx.ID_ANY)
        self.list_inputs_step4.AppendTextColumn("Name")
        self.list_inputs_step4.AppendTextColumn("Value")
        self.list_outputs_step4 = dv.DataViewListCtrl(self.panel_right_step4, wx.ID_ANY)
        self.list_outputs_step4.AppendTextColumn("Name")
        self.list_outputs_step4.AppendTextColumn("Value")
        self.list_inputs_step5 = dv.DataViewListCtrl(self.panel_left_step5, wx.ID_ANY)
        self.list_inputs_step5.AppendTextColumn("Name")
        self.list_inputs_step5.AppendTextColumn("Value")
        self.list_outputs_step5 = dv.DataViewListCtrl(self.panel_right_step5, wx.ID_ANY)
        self.list_outputs_step5.AppendTextColumn("Name")
        self.list_outputs_step5.AppendTextColumn("Value")
        self.list_pipeline = dv.DataViewListCtrl(self.panel_pipeline, wx.ID_ANY)
        self.list_pipeline.AppendTextColumn("Nro.", width=50)
        self.list_pipeline.AppendTextColumn("Assembly Codes", width=150)
        self.list_pipeline.AppendTextColumn("Step", width=50)
        self.list_pipeline.AppendTextColumn("Step", width=50)
        self.list_pipeline.AppendTextColumn("Step", width=50)
        self.list_pipeline.AppendTextColumn("Step", width=50)
        self.list_pipeline.AppendTextColumn("Step", width=50)
