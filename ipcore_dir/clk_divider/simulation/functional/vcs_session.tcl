...
gui_sg_addsignal -group clk_divider_group {{Status_control}} -divider
gui_sg_addsignal -group clk_divider_group {clk_divider_tb.RESET}
gui_sg_addsignal -group clk_divider_group {clk_divider_tb.LOCKED}
